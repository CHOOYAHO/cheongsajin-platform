    ...
    <section className="ai-interview-panel">
      ...
      {phase === 'application' && selectedCompany && (
        <form className="ai-application-form" onSubmit={(event) => { event.preventDefault(); void startInterview() }}>
          ...
          <label>이 직무를 위해 앞으로 무엇을 준비하고 싶나요?<textarea value={application.experience} onChange={(event) => setApplication({ ...application, experience: event.target.value })} maxLength={500} placeholder="더 알아보고 싶은 내용이나 키우고 싶은 역량, 해 보고 싶은 활동을 적어 주세요." /></label>
