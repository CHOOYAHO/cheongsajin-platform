...
function topicWithParticle(text: string, withFinal: string, withoutFinal: string) {
  return `${text}${topicParticle(text, withFinal, withoutFinal)}`
}
...
const staffSessionPlans: Record<number, StaffSessionPlan> = {
  ...
  4: {
    title: '진로 포트폴리오', subtitle: '1~3회기 기록을 종합해 Notion 진로 포트폴리오를 만들어요.', description: '지금까지 발견한 흥미, 역량, 관심 직업, 새롭게 알게 된 내용을 종합해 미래의 나를 구체화하고 개인별 Notion 진로 포트폴리오로 정리하는 회기예요.', icon: '🗺️', theme: 'blueprint',
    activities: [
      { duration: '20분', title: '지금까지의 활동 돌아보기', description: '내가 좋아하는 것, 내가 가진 역량, 관심 직업, 새롭게 발견한 내용을 1~3회기 기록에서 골라요.', mentorTip: '모든 기록을 옮기기보다 자신에게 중요한 내용을 선택하게 해 주세요.' },
      { duration: '20분', title: '미래의 나 상상하기', description: '지금까지의 기록을 바탕으로 미래의 내 모습과 일하는 장면을 구체적으로 떠올려요.', mentorTip: '막연한 꿈보다 어디서, 누구와, 무엇을 하는지 장면으로 말하게 해 주세요.' },
      { duration: '35분', title: 'Notion 진로 포트폴리오 제작', description: '활동책자와 홈페이지에 축적한 내용을 활용해 개인별 Notion 포트폴리오를 만들어요.', mentorTip: '기존 기록을 단순 복사하지 않고 자기 언어로 재구성하도록 안내해 주세요.' },
      ...
      { duration: '10분', title: '활동과 변화 돌아보기', description: '지금까지의 활동을 되돌아보고 처음과 달라진 생각, 새로 생긴 관심을 정리해요.', mentorTip: '작은 변화도 의미 있는 발견으로 인정해 주세요.' },
    ],
  },
  5: {
    title: '강사 프로그램', subtitle: '전문강사와 함께 다양한 진로와 직업을 탐색해요.', description: '전문강사와 협의해 확정되는 참여형 진로 프로그램 회기예요. 현재 웹페이지에서는 확인되지 않은 세부 활동을 임의로 만들지 않고 운영 방향만 안내해요.', icon: '💬', theme: 'interview',
    activities: [
      { duration: '협의', title: '전문강사 연계 프로그램', description: '강사의 전문영역과 실제 운영 가능한 프로그램에 맞춰 진로와 직업을 탐색해요.', mentorTip: '세부 활동은 강사 운영안이 확인된 뒤 반영해 주세요.' },
      { duration: '협의', title: '참여형 진로 활동', description: '강사의 진행에 따라 학생들이 직접 참여하고 생각을 나누는 활동을 진행해요.', mentorTip: '확정되지 않은 진행 방식을 홈페이지에서 먼저 고정하지 않아요.' },
      { duration: '협의', title: '활동 내용 정리', description: '강사 프로그램을 통해 새롭게 알게 된 내용과 관심 분야를 자신의 언어로 남겨요.', mentorTip: '학생이 활동에서 발견한 내용을 편안하게 정리하도록 도와주세요.' },
    ],
  },
}
...
const interviewCompanies: InterviewCompany[] = [
  { name: '예청건설', fields: ['건축', '토목', '현장관리'], description: '건물과 도로, 공공시설을 계획하고 안전하게 완성하는 회사예요. 현장과 사무실을 오가며 일정, 안전, 품질을 함께 관리해요.', roles: ['건축가', '토목기술자', '현장관리자', '안전관리자'], strengths: ['책임감', '공간지각능력', '문제해결능력', '협업능력'], imageTone: 'construction', imageLabel: '건설 현장' },
  { name: '예청전자', fields: ['전자제품', '로봇', '데이터'], description: '생활을 편리하게 만드는 전자기기와 디지털 기술을 개발하는 회사예요. 아이디어를 제품으로 만들기 위해 실험과 분석을 반복해요.', roles: ['로봇공학자', '소프트웨어 개발자', '데이터 분석가', '품질관리자'], strengths: ['논리적 사고', '분석력', '디지털 활용능력', '끈기'], imageTone: 'electronics', imageLabel: '전자 연구실' },
  { name: '예청엔터테인먼트', fields: ['콘텐츠', '공연', '영상'], description: '음악, 영상, 공연, 온라인 콘텐츠를 기획하고 제작하는 회사예요. 사람들의 관심을 읽고 새로운 이야기를 매력적으로 보여 줘요.', roles: ['콘텐츠 기획자', '영상 제작자', '공연 연출가', '마케팅 담당자'], strengths: ['창의성', '표현력', '기획력', '의사소통능력'], imageTone: 'entertainment', imageLabel: '콘텐츠 스튜디오' },
  { name: '예청모터스', fields: ['자동차', '정비', '모빌리티'], description: '자동차와 이동수단을 만들고 고치며 더 안전한 이동을 고민하는 회사예요. 기계 구조를 이해하고 문제를 정확히 찾아내는 힘이 중요해요.', roles: ['자동차 정비사', '기계공학자', '자동차 디자이너', '서비스 매니저'], strengths: ['손재주', '관찰력', '문제해결능력', '꼼꼼함'], imageTone: 'motors', imageLabel: '모빌리티 정비소' },
  { name: '예청중학교', fields: ['교육', '상담', '학교 행정'], description: '학생들이 배우고 성장할 수 있도록 수업, 상담, 생활지도, 학교 운영을 함께하는 교육기관이에요.', roles: ['교사', '상담교사', '학교 행정직', '진로전담교사'], strengths: ['공감능력', '책임감', '설명력', '관찰력'], imageTone: 'school', imageLabel: '학교 교실' },
  { name: '예청약품', fields: ['의약품', '연구', '품질'], description: '사람들의 건강을 돕는 의약품과 건강 관련 제품을 연구하고 관리하는 회사예요. 정확함과 윤리의식이 특히 중요해요.', roles: ['약사', '의약품 연구원', '품질관리자', '임상시험 코디네이터'], strengths: ['꼼꼼함', '책임감', '분석력', '집중력'], imageTone: 'pharma', imageLabel: '의약품 연구실' },
  { name: '예청은행', fields: ['금융', '상담', '회계'], description: '개인과 기업의 돈을 안전하게 관리하고 필요한 금융 서비스를 제공하는 기관이에요. 신뢰와 숫자 감각, 설명 능력이 필요해요.', roles: ['은행원', '금융상담사', '회계 담당자', '자산관리사'], strengths: ['신뢰감', '수리능력', '설명력', '정확성'], imageTone: 'bank', imageLabel: '금융 상담실' },
  { name: '예청식품', fields: ['식품개발', '조리', '마케팅'], description: '맛있고 안전한 식품을 개발하고 생산해 사람들에게 전달하는 회사예요. 위생, 창의성, 소비자 이해가 함께 필요해요.', roles: ['요리사', '식품 연구원', '브랜드 마케터', '영양사'], strengths: ['창의성', '위생관리', '관찰력', '실행력'], imageTone: 'food', imageLabel: '식품 개발실' },
  { name: '예청군청', fields: ['행정', '복지', '지역정책'], description: '지역 주민의 생활을 돕고 예청 지역의 정책과 공공서비스를 운영하는 기관이에요. 행정직의 다양한 모습을 살펴볼 수 있어요.', roles: ['일반행정직', '사회복지직', '청소년정책 담당자', '문화관광 담당자'], strengths: ['책임감', '문서정리능력', '공정성', '의사소통능력'], imageTone: 'office', imageLabel: '공공 행정 사무실' },
  { name: '예청병원', fields: ['의료', '간호', '재활'], description: '아픈 사람을 돌보고 건강을 회복할 수 있도록 진료, 간호, 재활, 병원 운영을 함께하는 기관이에요. 침착함과 책임감, 공감하는 태도가 중요해요.', roles: ['간호사', '물리치료사', '응급구조사', '병원행정직'], strengths: ['공감능력', '책임감', '침착함', '의사소통능력'], imageTone: 'hospital', imageLabel: '병원 진료실' },
  { name: '예청게임즈', fields: ['게임', '기획', '디자인'], description: '사람들이 즐길 수 있는 게임과 디지털 놀이 경험을 만드는 회사예요. 재미있는 아이디어를 규칙, 화면, 이야기로 구체화해요.', roles: ['게임 기획자', '게임 그래픽 디자이너', '프로그래머', '게임 운영자'], strengths: ['창의성', '논리적 사고', '협업능력', '문제해결능력'], imageTone: 'games', imageLabel: '게임 개발실' },
  { name: '예청호텔', fields: ['관광', '서비스', '운영'], description: '여행객과 손님이 편안한 시간을 보낼 수 있도록 숙박, 안내, 행사, 고객 서비스를 운영하는 회사예요. 친절함과 상황 대처 능력이 필요해요.', roles: ['호텔리어', '관광가이드', '행사 기획자', '고객 상담원'], strengths: ['친절함', '상황대처능력', '외국어 관심', '의사소통능력'], imageTone: 'hotel', imageLabel: '호텔 로비' },
  { name: '예청스포츠', fields: ['스포츠', '건강', '트레이닝'], description: '운동과 건강한 생활을 돕는 프로그램을 만들고 지도하는 회사예요. 목표를 세우고 꾸준히 훈련하며 사람들과 함께 성장하는 힘이 중요해요.', roles: ['운동선수', '스포츠 트레이너', '체육교사', '운동처방사'], strengths: ['성실함', '체력관리', '목표의식', '팀워크'], imageTone: 'sports', imageLabel: '스포츠 센터' },
  { name: '예청디자인', fields: ['디자인', '브랜드', '제품'], description: '사람들이 보기 쉽고 쓰기 좋은 제품, 화면, 브랜드 이미지를 만드는 회사예요. 관찰한 내용을 창의적으로 표현하는 힘이 필요해요.', roles: ['시각 디자이너', '제품 디자이너', '웹 디자이너', '브랜드 기획자'], strengths: ['창의성', '관찰력', '표현력', '사용자 이해'], imageTone: 'design', imageLabel: '디자인 스튜디오' },
  { name: '예청미디어', fields: ['방송', '뉴스', '콘텐츠'], description: '뉴스, 방송, 영상 콘텐츠를 만들고 사람들에게 필요한 정보를 전달하는 회사예요. 사실을 확인하고 알기 쉽게 표현하는 능력이 중요해요.', roles: ['방송 기자', '아나운서', 'PD', '영상 편집자'], strengths: ['표현력', '정보탐색능력', '책임감', '순발력'], imageTone: 'media', imageLabel: '방송 스튜디오' },
  { name: '예청동물병원', fields: ['수의', '동물돌봄', '생명과학'], description: '동물의 건강을 살피고 보호자에게 필요한 정보를 알려 주는 병원이에요. 동물을 세심하게 관찰하고 생명을 존중하는 태도가 중요해요.', roles: ['수의사', '동물보건사', '반려동물 훈련사', '동물보호 활동가'], strengths: ['관찰력', '공감능력', '책임감', '침착함'], imageTone: 'animal-clinic', imageLabel: '동물 진료실' },
  { name: '예청항공', fields: ['항공', '운항', '정비'], description: '사람과 물건이 안전하게 이동할 수 있도록 항공기 운항, 정비, 서비스를 관리하는 회사예요. 정확한 판단과 안전 의식이 매우 중요해요.', roles: ['조종사', '항공정비사', '승무원', '항공운항관리자'], strengths: ['안전의식', '집중력', '책임감', '상황대처능력'], imageTone: 'aviation', imageLabel: '공항 활주로' },
]
...
const getInterviewFeedbackLevel = (tone: InterviewFeedbackTone = 'neutral', score?: number): InterviewFeedbackLevel => {
  ...
  if (tone === 'bad') return 'weak'
  return 'neutral'
}
const interviewFeedbackIcon = (level: InterviewFeedbackLevel) => ({ excellent: '◎', good: '○', neutral: '△', weak: '!', bad: '×' }[level])
const interviewFeedbackClass = (tone: InterviewFeedbackTone = 'neutral', score?: number) => `feedback-${getInterviewFeedbackLevel(tone, score)}`
...
function CenterGuide() {
  return <>
    ...
    <section className="guide-content-card center-guide-visit"><div className="center-guide-heading"><p className="eyebrow">찾아오거나 문의하기</p><h2>수련관 이용 안내</h2></div><div className="center-info"><div><b>주소</b><span>충남 예산군 예산읍 벚꽃로 214-17</span></div><div><b>운영시간</b><span>화~금 09:00~21:00<br />토·일 09:00~18:00</span></div><div><b>문의</b><a href="tel:041-331-8228">041-331-8228</a></div></div><p className="center-guide-hours-note">월요일과 공휴일은 휴관해요. 방문 전 운영 여부를 확인해 주세요.</p><div className="center-links"><a href="https://www.yesanyouth.or.kr/main_sub/sub.php?folder_idx=2&folder_page_idx=69" target="_blank" rel="noreferrer">수련관 홈페이지 ↗</a><a href="https://www.yesanyouth.or.kr/edu/edu_list.php?folder_idx=2&folder_page_idx=40" target="_blank" rel="noreferrer">프로그램 살펴보기 ↗</a></div></section>
  </>
}
    ...
    <div className="app-shell">
      ...
      <main className="session-review activity-detail-page">
        ...
        {step === 4 && <section className="detail-panel">
          <div className="detail-heading"><span>마무리 기록</span><h2>면접을 통해 새롭게 알게 된 나를 정리해요</h2><p>잘 말한 부분과 더 준비하고 싶은 부분을 짧게 남기면 4회기 진로 포트폴리오로 이어갈 수 있어요.</p></div>
...
function CareerBrainstormTest({ role, playerName, onExit }: { role: BrainstormTestRole; playerName: string; onExit: () => void }) {
  ...
  const testScores = participants.map((nickname) => {
    const count = [...tasks, ...strengths].filter((item) => item.nickname === nickname).length
    return { id: nickname, nickname, score: count * 10, submissions: count }
  }).sort((left, right) => right.score - left.score || left.nickname.localeCompare(right.nickname, 'ko'))
  const myTestScore = testScores.find((score) => score.nickname === testName)?.score ?? 0
  ...
  const testScoreboard = role === 'host' && testScores.length > 0 ? <section className="brainstorm-scoreboard"><div><b>점수판</b><span>제출 1개당 10점 · 삭제 시 취소</span></div>{testScores.map((score) => <p key={score.id}><span>{score.nickname}</span><b>{score.score}점</b><small>{score.submissions}개</small></p>)}</section> : null
  ...
  const deleteTestSubmission = (target: BrainstormSubmission) => {
    if (role !== 'host') return
    if (target.part === 'tasks') setTasks((current) => current.filter((item) => item.id !== target.id))
    else setStrengths((current) => current.filter((item) => item.id !== target.id))
  }
  ...
  if (phase === 'WAITING') return <div className="brainstorm-room">{testHeader}<div className="room-summary"><div><span>방 코드</span><strong>TEST</strong></div><div><span>라운드</span><strong>{round} / {totalRounds}</strong></div><div><span>내 역할</span><strong>{role === 'host' ? '방장' : '참가자'}</strong></div><div><span>내 점수</span><strong>{myTestScore}점</strong></div></div><section className="brainstorm-waiting"><div className="auction-section-title"><h3>테스트 참가자</h3><span>가상 참가자 자동 응답</span></div><ul className="participant-list">{participants.map((name, index) => <li key={name}><i />{name}{index === 0 ? <b>방장</b> : <span>{name === testName ? '나' : 'BOT'}</span>}</li>)}</ul>{role === 'host' && <div className="brainstorm-host-settings"><label>라운드 수<input type="number" min={1} max={5} value={totalRounds} onChange={(event) => setTotalRounds(Math.max(1, Math.min(5, Number(event.target.value))))} /></label><label>제한시간<select value={timeLimit} onChange={(event) => setTimeLimit(Number(event.target.value))}><option value={30}>30초</option><option value={60}>60초</option><option value={90}>90초</option></select></label></div>}<div className="brainstorm-job-picker"><h3>{round}라운드 직업 선택</h3><div className="job-options">{brainstormJobs.map((item) => <button type="button" className={selectedJob === item && !customJob ? 'selected' : ''} onClick={() => { setSelectedJob(item); setCustomJob('') }} disabled={role === 'participant'} key={item}>{item}</button>)}</div>{role === 'host' && <label>직업 직접 입력<input value={customJob} onChange={(event) => setCustomJob(event.target.value)} maxLength={24} placeholder="예: 행정직 공무원" /></label>}<button type="button" className="auction-primary" onClick={beginCountdown}>{role === 'host' ? '테스트 시작' : '가상 방장에게 시작 요청'}</button></div></section></div>
  if (phase === 'COUNTDOWN') return <div className="brainstorm-room">{testHeader}{testScoreboard}<section className="brainstorm-countdown"><p>이번 직업은</p><h2>{job}</h2><strong>{remaining}</strong><span>초 뒤 시작합니다</span>{role === 'host' && remaining <= 0 && <button type="button" onClick={() => beginPart('TASKS')}>파트 1 시작</button>}</section></div>
  if (phase === 'TASKS') return <div className="brainstorm-room">{testHeader}{testScoreboard}<section className="brainstorm-play"><div className="detail-heading"><span>PART 1 · 수행 업무 · {remaining || '시간 종료'}초</span><h2>{topicWithParticle(job, '은', '는')} 실제 현장에서 어떤 일을 할까요?</h2><p>생각나는 업무를 하나씩 계속 추가해요. 제출하면 아래 공용 칠판에 바로 붙고, 입력창은 다음 아이디어를 적을 수 있게 비워져요.</p></div><div className="brainstorm-submit"><textarea value={answer} onChange={(event) => setAnswer(event.target.value)} maxLength={240} placeholder="예: 수업 준비하기, 학생 상담하기, 문서 처리하기" /><button type="button" onClick={() => addMine('tasks')}>공용 칠판에 추가</button></div><div className="brainstorm-board-heading"><b>공용 업무 칠판</b><span>{currentTasks.length}개</span></div><div className="brainstorm-board">{currentTasks.map((item) => <article key={item.id}><b>{item.nickname}</b>{role === 'host' && <button type="button" className="brainstorm-delete" onClick={() => deleteTestSubmission(item)} aria-label="제출 항목 삭제">삭제</button>}<p>{item.text}</p></article>)}</div><button type="button" className="auction-primary" onClick={() => beginPart('STRENGTHS')}>{role === 'host' ? '파트 2로 이동' : '가상 방장 파트 2 진행'}</button></section></div>
  if (phase === 'STRENGTHS') return <div className="brainstorm-room">{testHeader}{testScoreboard}<section className="brainstorm-play"><div className="detail-heading"><span>PART 2 · 필요 역량 · {remaining || '시간 종료'}초</span><h2>이 업무들을 잘하려면 어떤 역량이 필요할까요?</h2><p>파트1에서 나온 업무를 보며 필요한 역량을 하나씩 계속 추가해요. 모두가 같은 공용 칠판을 함께 채웁니다.</p></div><div className="brainstorm-task-strip">{currentTasks.map((item) => <span key={item.id}>{item.text}</span>)}</div><div className="brainstorm-submit"><textarea value={answer} onChange={(event) => setAnswer(event.target.value)} maxLength={240} placeholder="예: 의사소통능력, 책임감, 계획성, 공감능력" /><button type="button" onClick={() => addMine('strengths')}>공용 칠판에 추가</button></div><div className="brainstorm-board-heading"><b>공용 역량 칠판</b><span>{currentStrengths.length}개</span></div><div className="brainstorm-board strength">{currentStrengths.map((item) => <article key={item.id}><b>{item.nickname}</b>{role === 'host' && <button type="button" className="brainstorm-delete" onClick={() => deleteTestSubmission(item)} aria-label="제출 항목 삭제">삭제</button>}<p>{item.text}</p></article>)}</div><button type="button" className="auction-primary" onClick={() => setPhase('ROUND_RESULT')}>{role === 'host' ? '라운드 결과 보기' : '가상 방장 결과 보기'}</button></section></div>
  if (phase === 'ROUND_RESULT') return <div className="brainstorm-room">{testHeader}{testScoreboard}<section className="brainstorm-result"><h2>{job} 브레인스토밍 결과</h2><div><article><h3>수행 업무</h3>{currentTasks.map((item) => <p key={item.id}>{item.text}</p>)}</article><article><h3>필요 역량</h3>{currentStrengths.map((item) => <p key={item.id}>{item.text}</p>)}</article></div><button type="button" className="auction-primary" onClick={nextRound}>{round >= totalRounds ? '최종 결과 보기' : '다음 라운드 준비'}</button></section></div>
  return <div className="brainstorm-room">{testHeader}{testScoreboard}<section className="brainstorm-result"><h2>테스트 활동 결과</h2><p>Firebase에 저장되지 않은 연습 결과입니다.</p>{testScores.length > 0 && <section className="brainstorm-ranking"><h3>최종 랭킹</h3><div>{testScores.map((score, index) => <article key={score.id} className={index === 0 ? 'winner' : ''}><span>{index + 1}위</span><b>{score.nickname}</b><strong>{score.score}점</strong><small>제출 {score.submissions}개</small></article>)}</div></section>}<div>{Array.from({ length: totalRounds }, (_, index) => index + 1).map((roundNumber) => <article key={roundNumber}><h3>{roundNumber}라운드</h3>{[...tasks, ...strengths].filter((item) => item.round === roundNumber).map((item) => <p key={item.id}><b>{item.part === 'tasks' ? '업무' : '역량'}</b> {item.text}</p>)}</article>)}</div><button type="button" className="auction-primary" onClick={onExit}>테스트 선택으로 돌아가기</button></section></div>
}
...
function CareerBrainstormGame({ schoolName, studentName }: { schoolName: string; studentName: string }) {
  ...
  const brainstormJobs = ['교사', '간호사', '로봇공학자', '사회복지사', '공무원', '요리사', '데이터 분석가', '콘텐츠 기획자', '자동차 정비사', '심리상담사']
  const openRoomStates: BrainstormRoom['gameState'][] = ['WAITING', 'COUNTDOWN', 'TASKS', 'STRENGTHS', 'ROUND_RESULT']
  const roomStateLabel: Record<BrainstormRoom['gameState'], string> = { WAITING: '대기 중', COUNTDOWN: '시작 준비', TASKS: '업무 입력 중', STRENGTHS: '역량 입력 중', ROUND_RESULT: '라운드 결과', RESULT: '종료', CLOSED: '닫힘' }
  const participantScores = participants.map((participant) => {
    const participantSubmissions = submissions.filter((item) => item.userId === participant.id)
    return { id: participant.id, nickname: participant.nickname, score: participantSubmissions.length * 10, submissions: participantSubmissions.length }
  }).sort((left, right) => right.score - left.score || left.nickname.localeCompare(right.nickname, 'ko'))
  const myScore = participantScores.find((score) => score.id === auth?.currentUser?.uid)?.score ?? 0

  useEffect(() => {
    if (!db || roomCode) return
    return onSnapshot(query(collection(db, 'brainstormRooms'), where('gameState', 'in', openRoomStates)), (snapshot) => {
      const now = Date.now()
      setOpenRooms(snapshot.docs
        .map((item) => ({ id: item.id, ...(item.data() as Omit<BrainstormRoom, 'id'>) }))
        .filter((room) => room.updatedAt?.toMillis && now - room.updatedAt.toMillis() < 90000)
  ...
  useEffect(() => {
    ...
    const heartbeat = window.setInterval(() => {
      void updateDoc(participantRef, { connected: true }).catch(() => undefined)
      if (role === 'host') void updateDoc(roomRef, { updatedAt: serverTimestamp() }).catch(() => undefined)
    }, 20000)
    return () => {
      stopRoom(); stopParticipants(); stopSubmissions(); window.clearInterval(heartbeat)
      void updateDoc(participantRef, { connected: false }).catch(() => undefined)
      if (role === 'host') void updateDoc(roomRef, { gameState: 'CLOSED', phaseEndsAt: null, updatedAt: serverTimestamp() }).catch(() => undefined)
    }
  }, [roomCode])
  ...
  const joinRoom = async (code: string) => {
    ...
    const targetRoom = snapshot.data() as BrainstormRoom
    if (['CLOSED', 'RESULT'].includes(targetRoom.gameState)) { setError('이미 종료된 방이에요.'); return }
    const participantRef = doc(db, 'brainstormRooms', normalized, 'participants', auth.currentUser.uid)
    const participantSnapshot = await getDoc(participantRef)
    if (participantSnapshot.exists()) await updateDoc(participantRef, { nickname: myName, connected: true, lastSeenAt: serverTimestamp() })
    else await setDoc(participantRef, { nickname: myName, role: 'participant', connected: true, joinedAt: serverTimestamp(), lastSeenAt: serverTimestamp() })
    setRole('participant')
  ...
  const leaveBrainstormRoom = async () => {
    if (db && auth?.currentUser && roomCode) {
      await updateDoc(doc(db, 'brainstormRooms', roomCode, 'participants', auth.currentUser.uid), { connected: false }).catch((caught) => console.error(caught))
      if (isHost) await updateDoc(doc(db, 'brainstormRooms', roomCode), { gameState: 'CLOSED', phaseEndsAt: null, updatedAt: serverTimestamp() }).catch((caught) => console.error(caught))
    }
    setRoomCode('')
    setRole(null)
    setRoomData(null)
  ...
  if (!roomCode) return <div className="brainstorm-lobby"><div className="brainstorm-title"><span>실시간 활동</span><h2>핵심 역량 브레인스토밍</h2><p>방장이 방을 열면 참가자는 로비에서 바로 들어가요. 직업별 실제 업무와 필요한 역량을 함께 모읍니다.</p></div><label>내 이름<input value={nickname} onChange={(event) => setNickname(event.target.value)} maxLength={12} placeholder="활동에서 보일 이름" /></label><div className="brainstorm-host-settings"><label>라운드 수<input type="number" min={1} max={10} value={totalRounds} onChange={(event) => setTotalRounds(Math.max(1, Math.min(10, Number(event.target.value))))} /></label><label>라운드당 제한시간<select value={timeLimit} onChange={(event) => setTimeLimit(Number(event.target.value))}><option value={30}>30초</option><option value={60}>60초</option><option value={90}>90초</option><option value={120}>120초</option></select></label><button type="button" onClick={createRoom}>방 만들기</button></div><section className="open-room-list"><div><h3>개설된 방</h3><span>{openRooms.length}개</span></div>{openRooms.length ? openRooms.map((room) => <button type="button" key={room.id} onClick={() => void joinRoom(room.id!)}><b>{room.hostName || '방장'}의 방</b><span>{roomStateLabel[room.gameState]} · {room.totalRounds}라운드 · {room.timeLimit}초</span><small>{room.id}</small></button>) : <p>아직 열린 방이 없어요. 방장이 방을 만들면 여기에 표시됩니다.</p>}</section><div className="manual-room-entry"><input value={joinCode} onChange={(event) => setJoinCode(event.target.value.replace(/\D/g, '').slice(0, 6))} placeholder="방 코드 직접 입력" /><button type="button" onClick={() => void joinRoom(joinCode)} disabled={joinCode.length !== 6}>입장</button></div>{error && <p className="entry-error" role="alert">{error}</p>}<section className="auction-test-section"><div className="auction-section-title"><div><span>혼자서도 연습 가능</span><h3>테스트 게임</h3></div><b>Firebase 저장 없음</b></div><p>가상 참가자들과 수행 업무와 필요 역량을 모으는 전체 흐름을 미리 확인해 보세요.</p><div><button type="button" onClick={() => setTestRole('host')}><span>👑</span><b>방장으로 테스트</b><small>직업 선택·파트 전환·결과 진행</small></button><button type="button" onClick={() => setTestRole('participant')}><span>🙋</span><b>참여자로 테스트</b><small>업무 제출·역량 제출·결과 확인</small></button></div></section></div>

  return <div className="brainstorm-room"><div className="room-toolbar"><button type="button" onClick={leaveBrainstormRoom}>{isHost ? '방 닫고 나가기' : '방 나가기'}</button></div><div className="room-summary"><div><span>방 코드</span><strong>{roomCode}</strong></div><div><span>현재 라운드</span><strong>{roomData?.round ?? 1} / {roomData?.totalRounds ?? totalRounds}</strong></div><div><span>남은 시간</span><strong>{remaining || '-'}</strong></div><div><span>내 점수</span><strong>{myScore}점</strong></div></div>{isHost && participantScores.length > 0 && <section className="brainstorm-scoreboard"><div><b>점수판</b><span>제출 1개당 10점 · 삭제 시 취소</span></div>{participantScores.map((score) => <p key={score.id}><span>{score.nickname}</span><b>{score.score}점</b><small>{score.submissions}개</small></p>)}</section>}{roomData?.gameState === 'CLOSED' && <section className="brainstorm-result"><h2>방이 닫혔어요.</h2><p>방장이 나가서 이 방은 더 이상 로비에 표시되지 않습니다.</p><button type="button" className="auction-primary" onClick={leaveBrainstormRoom}>로비로 돌아가기</button></section>}{roomData?.gameState === 'WAITING' && <section className="brainstorm-waiting"><div className="auction-section-title"><h3>참가자</h3><span>{participants.length}명</span></div><ul className="participant-list">{participants.map((participant) => <li key={participant.id}><i className={participant.connected === false ? 'offline' : ''} />{participant.nickname}{participant.role === 'host' ? <b>방장</b> : <span>참가</span>}</li>)}</ul>{isHost ? <div className="brainstorm-job-picker"><h3>{roomData.round}라운드 직업 선택</h3><div className="job-options">{brainstormJobs.map((job) => <button type="button" className={selectedJob === job ? 'selected' : ''} onClick={() => { setSelectedJob(job); setCustomJob('') }} key={job}>{job}</button>)}</div><label>직업 직접 입력<input value={customJob} onChange={(event) => setCustomJob(event.target.value)} maxLength={24} placeholder="예: 행정직 공무원" /></label><button type="button" className="auction-primary" onClick={startRound}>게임 시작 전 5초 카운트다운</button></div> : <div className="participant-wait"><h3>방장이 직업을 고르고 있어요.</h3><p>잠시 후 활동이 시작됩니다.</p></div>}</section>}{roomData?.gameState === 'COUNTDOWN' && <section className="brainstorm-countdown"><p>이번 직업은</p><h2>{roomData.currentJob}</h2><strong>{remaining}</strong><span>초 뒤 시작합니다</span>{isHost && remaining <= 0 && <button type="button" onClick={() => void movePhase('TASKS')}>파트 1 시작</button>}</section>}{roomData?.gameState === 'TASKS' && <section className="brainstorm-play"><div className="detail-heading"><span>PART 1 · 수행 업무</span><h2>{topicWithParticle(roomData.currentJob, '은', '는')} 실제 현장에서 어떤 일을 할까요?</h2><p>생각나는 업무를 하나씩 계속 추가해요. 제출하면 모두가 보는 공용 칠판에 바로 붙고, 입력창은 다음 아이디어를 적을 수 있게 비워져요.</p></div><div className="brainstorm-submit"><textarea value={answer} onChange={(event) => setAnswer(event.target.value)} maxLength={240} placeholder="예: 수업 준비하기, 학생 상담하기, 문서 처리하기" /><button type="button" onClick={submitAnswer}>공용 칠판에 추가</button></div><div className="brainstorm-board-heading"><b>공용 업무 칠판</b><span>{taskSubmissions.length}개</span></div><div className="brainstorm-board">{taskSubmissions.map((item) => <article key={item.id}><b>{item.nickname}</b>{isHost && <button type="button" className="brainstorm-delete" onClick={() => void deleteSubmission(item.id)} aria-label="제출 항목 삭제">삭제</button>}<p>{item.text}</p></article>)}</div>{isHost && <button type="button" className="auction-primary" onClick={() => void movePhase('STRENGTHS')}>파트 2로 이동</button>}</section>}{roomData?.gameState === 'STRENGTHS' && <section className="brainstorm-play"><div className="detail-heading"><span>PART 2 · 필요 역량</span><h2>이 업무들을 잘하려면 어떤 역량이 필요할까요?</h2><p>파트 1에서 나온 업무를 보며 필요한 역량을 하나씩 계속 추가해요. 모두가 같은 공용 칠판을 함께 채웁니다.</p></div><div className="brainstorm-task-strip">{taskSubmissions.map((item) => <span key={item.id}>{item.text}</span>)}</div><div className="brainstorm-submit"><textarea value={answer} onChange={(event) => setAnswer(event.target.value)} maxLength={240} placeholder="예: 의사소통능력, 책임감, 계획성, 공감능력" /><button type="button" onClick={submitAnswer}>공용 칠판에 추가</button></div><div className="brainstorm-board-heading"><b>공용 역량 칠판</b><span>{strengthSubmissions.length}개</span></div><div className="brainstorm-board strength">{strengthSubmissions.map((item) => <article key={item.id}><b>{item.nickname}</b>{isHost && <button type="button" className="brainstorm-delete" onClick={() => void deleteSubmission(item.id)} aria-label="제출 항목 삭제">삭제</button>}<p>{item.text}</p></article>)}</div>{isHost && <button type="button" className="auction-primary" onClick={() => void movePhase('ROUND_RESULT', 0)}>라운드 결과 보기</button>}</section>}{roomData?.gameState === 'ROUND_RESULT' && <section className="brainstorm-result"><h2>{roomData.currentJob} 브레인스토밍 결과</h2><div><article><h3>수행 업무</h3>{taskSubmissions.map((item) => <p key={item.id}>{item.text}</p>)}</article><article><h3>필요 역량</h3>{strengthSubmissions.map((item) => <p key={item.id}>{item.text}</p>)}</article></div>{isHost && <button type="button" className="auction-primary" onClick={nextRound}>{roomData.round >= roomData.totalRounds ? '최종 결과 보기' : '다음 라운드 준비'}</button>}</section>}{roomData?.gameState === 'RESULT' && <section className="brainstorm-result"><h2>활동 결과</h2><p>모둠이 함께 모은 직업별 업무와 필요 역량입니다.</p>{participantScores.length > 0 && <section className="brainstorm-ranking"><h3>최종 랭킹</h3><div>{participantScores.map((score, index) => <article key={score.id} className={index === 0 ? 'winner' : ''}><span>{index + 1}위</span><b>{score.nickname}</b><strong>{score.score}점</strong><small>제출 {score.submissions}개</small></article>)}</div></section>}<div>{Array.from({ length: roomData.totalRounds }, (_, index) => index + 1).map((round) => <article key={round}><h3>{round}라운드</h3>{submissions.filter((item) => item.round === round).map((item) => <p key={item.id}><b>{item.part === 'tasks' ? '업무' : '역량'}</b> {item.text}</p>)}</article>)}</div></section>}{error && <p className="entry-error" role="alert">{error}</p>}</div>
}
...
function AiInterviewActivity({ schoolName, displayName }: { schoolName: string; displayName: string }) {
  ...
  const submitAnswer = async (finishNow = false) => {
    ...
    try {
      ...
      setTurns(result?.turns ?? answeredTurns)
      setAnswer('')
      setCurrentHint({ intent: '', guide: '' })
      setLastFeedback(result?.feedback ?? '')
      setFeedbackTone(result?.feedbackTone ?? 'neutral')
    ...
    <section className="ai-interview-panel">
      ...
      {phase === 'application' && selectedCompany && (
        <form className="ai-application-form" onSubmit={(event) => { event.preventDefault(); void startInterview() }}>
          ...
          <label>{isGwangsi ? '이 일을 위해 가볍게 해 보고 싶은 일이 있나요?' : '이 직무를 위해 앞으로 무엇을 준비하고 싶나요?'}<textarea value={application.experience} onChange={(event) => setApplication({ ...application, experience: event.target.value })} maxLength={500} placeholder={isGwangsi ? '학교나 집에서 해 보고 싶은 작은 일 하나를 적어 주세요.' : '더 알아보고 싶은 내용이나 키우고 싶은 역량, 해 보고 싶은 활동을 적어 주세요.'} /></label>
      ...
      {phase === 'result' && <div className={`ai-result-card ${decision}`}><span>면접 완료</span><div className="interview-decision"><b>{decision === 'pass' ? '합격' : decision === 'hold' ? '보류' : '재도전'}</b><small>{`${interviewScore}점`}</small></div><h3>{selectedCompany?.name} · {application.role === '직접 입력' ? customRole : application.role}</h3>{closingSummary ? <p>{closingSummary}</p> : <p>면접 답변이 활동 기록으로 저장됐어요. 선생님과 멘토가 이후 활동에서 함께 돌아볼 수 있습니다.</p>}<div className="score-rubric"><b>점수 기준</b><div><span>지원 동기</span><span>직무 이해</span><span>자기 강점</span><span>상황 판단</span><span>협업·책임</span><span>성장 계획</span><span>마무리 표현</span></div><p>경험의 양이 아니라 질문에 맞는 생각, 판단 이유, 직무 연결과 성실한 태도를 종합해 평가해요.</p></div>{suggestedStrengths.length > 0 && <div className="result-strengths">{suggestedStrengths.map((strength) => <b key={strength}>{strength}</b>)}</div>}<div className="-log-preview">{turns.map((turn, index) => <article key={`${turn.question}-${index}`}><strong>Q{index + 1}. {turn.question}</strong>{typeof turn.answerScore === 'number' && <small className="turn-score-badge">답변 {turn.answerScore}점 / 평균 {turn.cumulativeScore ?? turn.answerScore}점</small>}<p>{turn.answer}</p></article>)}</div><button type="button" onClick={resetInterview}>새 면접 시작하기</button></div>}
...
function MentorThirdResultsPage({ displayName, masterViewLabel, onLeave }: { displayName: string; masterViewLabel?: string; onLeave: () => void }) {
  ...
  const [interviews, setInterviews] = useState<InterviewLogRecord[]>([])
  const [isLoading, setIsLoading] = useState(true)
  const [error, setError] = useState('')
  const currentUserId = auth?.currentUser?.uid ?? ''

  useEffect(() => {
    if (!db) { setError('Firebase 연결을 확인해 주세요.'); setIsLoading(false); return }
    const firestore = db
    setIsLoading(true)
    setError('')
  ...
  const visibleRooms = brainstormRooms.filter((room) => activeTab === 'mine'
    ? room.hostId === currentUserId || (room.scores ?? []).some((score) => score.id === currentUserId)
    : (room.schoolName ?? '').includes(schoolKeyword))
  const visibleInterviews = interviews.filter((record) => activeTab === 'mine'
...
function AdminInterviewResultsPanel() {
  ...
  const [showTurnFeedback, setShowTurnFeedback] = useState(false)
  ...
  const recordGroup = (record: InterviewLogRecord): InterviewRecordFilter => {
    const name = recordName(record)
    const school = recordSchool(record)
    if (record.userRole === 'admin' || ['추규한', '관리자1', '관리자2'].includes(name) || school.includes('관리자')) return 'admin'
    if (school.includes('광시')) return 'gwangsi'
    if (school.includes('예산')) return 'yesan'
    if (record.userRole === 'mentor' || record.userRole === 'teacher' || school.includes('멘토') || school.includes('교사')) return 'staff'
    return 'all'
  }
  const roleLabel = (record: InterviewLogRecord) => {
    const group = recordGroup(record)
    if (group === 'admin') return '관리자'
    if (record.userRole === 'mentor') return '멘토'
    if (record.userRole === 'teacher') return '교사'
    return '학생'
  }
  const matchesFilter = (record: InterviewLogRecord, filter: InterviewRecordFilter) => {
    if (filter === 'all') return true
    return recordGroup(record) === filter
  }
  ...
  const createInterviewBackup = async () => {
    if (!functions || backupState === 'working') return
    setBackupState('working')
    setBackupMessage('')
    try {
      const backup = httpsCallable<Record<string, never>, { backupId: string; documentCount: number }>(functions, 'backupAiInterviewData')
      const response = await backup({})
      setBackupState('done')
      setBackupMessage(`백업 완료 · 면접 기록 ${response.data.documentCount}건 · 백업 ID ${response.data.backupId}`)
    } catch (caught) {
      console.error(caught)
      setBackupState('error')
      setBackupMessage('백업에 실패했어요. 면접 로직 수정 전에 다시 시도해 주세요.')
    }
  }

  return <section className="admin-result-panel"><div className="admin-result-panel-heading"><div><span>3회기</span><h3>면접 결과</h3><p>학생, 멘토, 교사, 관리자까지 모든 면접 기록을 대상군별로 나눠 확인합니다.</p></div><b>{filteredRecords.length} / {records.length}건</b></div><div className="admin-record-toolbar"><div className="admin-record-filter-tabs">{filterTabs.map((tab) => <button type="button" className={activeFilter === tab.id ? 'active' : ''} onClick={() => { setActiveFilter(tab.id); setOpenRecordId(null) }} key={tab.id}>{tab.label}</button>)}</div><div className="admin-record-toolbar-actions"><label className="admin-feedback-toggle"><input type="checkbox" checked={showTurnFeedback} onChange={(event) => setShowTurnFeedback(event.target.checked)} />답변 피드백 보기</label><button type="button" className="admin-backup-button" onClick={() => void createInterviewBackup()} disabled={backupState === 'working'}>{backupState === 'working' ? '백업 중…' : '면접 기록 백업'}</button></div></div>{backupMessage && <p className={`admin-backup-message ${backupState}`} role="status">{backupMessage}</p>}{isLoading && <div className="empty-auction-records"><b>기록을 불러오는 중이에요.</b></div>}{error && <p className="entry-error" role="alert">{error}</p>}{!isLoading && !error && (filteredRecords.length ? <div className="admin-interview-records">{filteredRecords.map((record) => { const isOpen = openRecordId === record.id; const turns = record.turns ?? []; const savedFeedback = [...turns].reverse().find((turn) => turn.feedback)?.feedback; const latestFeedback = savedFeedback || (record.status === 'completed' ? '면접이 완료된 기록입니다.' : '진행 중인 면접 기록입니다.'); return <article className={isOpen ? 'open' : ''} key={record.id}><button type="button" className="admin-interview-summary" onClick={() => setOpenRecordId(isOpen ? null : record.id)}><span>{roleLabel(record)}</span><div><b>{recordName(record)}</b><small>{recordSchool(record)}</small></div><div><strong>{record.company || '회사 미기록'} · {record.application?.role || '직무 미기록'}</strong><p>{latestFeedback}</p></div><div><b>{decisionLabel(record.decision)}</b><small>{record.score ? `${record.score}점` : record.status === 'completed' ? '판정 완료' : '진행 중'}</small></div><i>{isOpen ? '접기' : '펼치기'}</i></button>{isOpen && (turns.length ? <div className="admin-interview-turns">{turns.map((turn, index) => <section key={`${record.id}-${index}`}><div><b>Q{index + 1}. {turn.question}</b>{typeof turn.answerScore === 'number' ? <em>답변 {turn.answerScore}점 / 평균 {turn.cumulativeScore ?? turn.answerScore}점</em> : <em>점수 기록 없음</em>}</div><p>{turn.answer}</p>{showTurnFeedback && (turn.feedback ? <small className={interviewFeedbackClass(turn.feedbackTone, turn.answerScore)}><span aria-hidden="true">{interviewFeedbackIcon(getInterviewFeedbackLevel(turn.feedbackTone, turn.answerScore))}</span>{turn.feedback}</small> : <small>저장된 피드백이 없어요.</small>)}</section>)}</div> : <p className="admin-interview-empty">아직 저장된 답변이 없어요.</p>)}</article> })}</div> : <div className="empty-auction-records"><b>해당 조건의 면접 기록이 없어요.</b><p>면접에서 한 문항 이상 답변하면 이곳에 표시됩니다.</p></div>)}</section>
}
...
function AdminPage({ displayName, accountTools, sessionLocks, sessionLockBusy, sessionLockError, onToggleSessionLock, onOpenPreferenceRecords, onOpenSession, onBack, onLeave }: { displayName: string; accountTools: ReactNode; sessionLocks: SessionLocksByTarget; sessionLockBusy: string | null; sessionLockError: string; onToggleSessionLock: (sessionNumber: number, target: SessionLockTarget, unlocked: boolean) => void; onOpenPreferenceRecords: () => void; onOpenSession: (sessionNumber: number) => void; onBack: () => void; onLeave: () => void }) {
  ...
  const openRecordSession = (sessionNumber: number) => {
    setActiveRecordSession(sessionNumber)
    setActiveRecordDetail(null)
  }
  const closeRecordSession = () => {
    setActiveRecordSession(null)
    setActiveRecordDetail(null)
  }
  return (
    <div className="app-shell">
...
function App() {
  ...
  useEffect(() => {
    ...
    const handleBack = (event: PopStateEvent) => {
      ...
      const thirdActivityMatch = /^activity-3-step-([1-5])$/.exec(view)
  ...
  if (activeGuide) {
    ...
    return <div className="app-shell">
      ...
      <main className="guide-detail-page">
        ...
        {activeGuide === 'center' && <CenterGuide />}
      </main>
      <PartnerFooter />
    </div>
  }

  if (activeSession === 3 && sessionPageMode === 'activity' && activeThirdActivity === 5 && isMentorView && (canPreviewFutureSessions || activeSessionLocks[3] === true)) {
    return <MentorThirdResultsPage displayName={viewDisplayName} masterViewLabel={masterViewLabel} onLeave={leave} />
  }

  if (activeSession === 3 && sessionPageMode === 'activity' && activeThirdActivity && activeThirdActivity <= 4 && (canPreviewFutureSessions || activeSessionLocks[3] === true)) {
      ...
      <div className="app-shell">
        ...
        <main className="session-review">
          ...
          <section className="review-section">
            ...
            {isMentorView && <button type="button" className="mentor-third-results-open" onClick={() => openThirdActivity(5)}><span>📊</span><div><b>학생 활동 결과 보기</b><small>광시중 · 예산고 · 내 결과를 나눠 확인해요.</small></div><strong>결과 열기 →</strong></button>}
